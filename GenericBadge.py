...
def GenericBadgeTemplate(badge, data):
    ...
    badge.register_font('symbol', 0.5)
    ...
    if data['ageAtEvent'] < 18:
        ...
        badge.draw.centertext((0, badge.height / 2), "\U0001F51E", font=badge.font('symbol'), v_align='center', h_align='left')
        badge.draw.centertext((badge.width, badge.height / 2), "\U0001F51E", font=badge.font('symbol'), v_align='center', h_align='right')
